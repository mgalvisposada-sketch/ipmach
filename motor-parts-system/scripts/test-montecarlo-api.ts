...
import { montecarloCombinedSteps } from '../prisma/steps';

/**
 * Test script to verify MONTECARLO API endpoint
 * Tests the /api/search/deep-web/MONTECARLO endpoint
 */
...
async function testMontecarloAPI() {
    console.log('🧪 Testing MONTECARLO API endpoint...\n');
    ...
    try {
        ...
        console.log(`   Origin: MONTECARLO`);
        console.log(`   Login Steps: ${montecarloCombinedSteps.length} steps\n`);
